...
import { X, Wallet, ChevronLeft, ChevronRight, ArrowRight } from "lucide-react";
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 animate-scale-in overflow-hidden">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-white/60">
                                    Select a date and set your budget
                                </p>
                            </div>
                        </div>
                        <button
                ...
                <div className="px-6 pb-6">
                    ...
                    <p className="text-[10px] text-gray-400 text-center mt-2">
                        Past dates cannot be selected. If no budget is set for a date,
                        the previous date's budget will be used automatically.
                    </p>
                </div>
            </div>
        </div>
