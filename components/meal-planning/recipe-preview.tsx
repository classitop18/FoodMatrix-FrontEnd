 ...
 */
    ...
    const renderChart = (): JSX.Element => {
        ...
        if (chartType === "line") {
            return (
                <LineChart data={nutritionData} margin={{ top: 20, right: 20, left: 0, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis />
                    <Tooltip content={<CustomTooltip />} />
            ...
            return (
                <PieChart>
                    <Pie
                        ...
                        cy="50%"
                        outerRadius={120}
                        label={(entry) => `${entry.name}: ${entry.value}${entry.unit || 'g'}`}
                    >
                        {nutritionData.map((entry, index) => (
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <Badge className={`${getCuisineColor(recipe.cuisineType)} border`}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-950/20 rounded-xl border border-green-200 dark:border-green-800">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-green-600">${recipe.costAnalysis?.totalCost || 0}</p>
                                    {recipe.costAnalysis && (
                            ...
                            <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-xl border border-blue-200 dark:border-blue-800">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-blue-600">{recipe.totalTimeMinutes || 0} min</p>
                                    <p className="text-xs text-gray-500 dark:text-gray-400">Quick & Easy</p>
                                </div>
                            </div>
                    ...
                    <>
                        ...
                        <div className="space-y-6">
                            <div className="space-y-6 pr-4">
                                            ...
                                            <CardContent className="p-6">
                                                ...
                                                <div className="grid gap-3">
                                                    {(Array.isArray(recipe.ingredients)
                                                        ? recipe.ingredients
                                                        : JSON.parse(recipe.ingredients || "[]") as any[]).map((ingredient:any, index:any) => (
                                                            <div
                                                                key={index}
                                        ...
                                        <Card className="border-2 shadow-md">
                                            <CardContent className="p-6">
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    {(Array.isArray(recipe.instructions)
                                                        ? recipe.instructions
                                                        : JSON.parse(recipe.instructions) as any[]).map((instruction:any, index:any) => (
                                        ...
                                        <CardContent className="p-6 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20">
                                            ...
                                            <div className="mb-6 p-4 bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 rounded-xl border-2 border-orange-300 dark:border-orange-700">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-lg font-bold text-gray-900 dark:text-white">Calories</span>
                                                    <span className="text-3xl font-bold text-orange-600">{recipe.nutrition.calories}</span>
                                                </div>
                                                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">per serving</p>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4">
                                                ...
                                                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border-2 border-blue-200 dark:border-blue-800">
                                                    ...
                                                    <p className="text-2xl font-bold text-blue-600">{recipe.nutrition.protein_g}g</p>
                                                </div>
                                                ...
                                                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border-2 border-amber-200 dark:border-amber-800">
                                                    ...
                                                    <p className="text-2xl font-bold text-amber-600">{recipe.nutrition.carbs_g}g</p>
                                                </div>
                                                ...
                                                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border-2 border-red-200 dark:border-red-800">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        ...
                                                        <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Fat</span>
                                                    </div>
                                                    <p className="text-2xl font-bold text-red-600">{recipe.nutrition.fat_g}g</p>
                                                </div>
                                                ...
                                                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border-2 border-green-200 dark:border-green-800">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        ...
                                                        <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Fiber</span>
                                                    </div>
                                                    <p className="text-2xl font-bold text-green-600">{recipe.nutrition.fiber_g}g</p>
                                                </div>
                                                ...
                                                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border-2 border-purple-200 dark:border-purple-800">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        ...
                                                        <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Sugar</span>
                                                    </div>
                                                    <p className="text-2xl font-bold text-purple-600">{recipe.nutrition.sugar_g}g</p>
                                                </div>
                                                ...
                                                <div className="p-4 bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 rounded-lg border-2 border-green-300 dark:border-green-700">
                                                    ...
                                                    <p className="text-2xl font-bold text-green-600">{recipe.healthScore}/100</p>
                                                </div>
                                            </div>

                                            {/* Additional Nutrients */}
                                            {(recipe.nutrition.sodium_mg || recipe.nutrition.cholesterol_mg) && (
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3">
                                                        {recipe.nutrition.sodium_mg && (
                                                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-900 rounded-lg">
                                                                ...
                                                                <span className="font-semibold text-gray-900 dark:text-white">{recipe.nutrition.sodium_mg}mg</span>
                                                            </div>
                                                        )}
                                                        {recipe.nutrition.cholesterol_mg && (
                                                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-900 rounded-lg">
                                                                <span className="text-sm text-gray-600 dark:text-gray-400">Cholesterol</span>
                                                                <span className="font-semibold text-gray-900 dark:text-white">{recipe.nutrition.cholesterol_mg}mg</span>
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                                    ...
                                    <Card className="border-2 shadow-md border-green-200 dark:border-green-800">
                                        <CardContent className="p-6 bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20">
                                            ...
                                            <div className="grid sm:grid-cols-2 gap-3">
                                                {(recipe.nutritionalHighlights as any[]).map((highlight, index) => (
                                                    <div key={index} className="flex items-center gap-3 p-3 bg-white dark:bg-gray-900 rounded-lg border border-green-200 dark:border-green-800">
                                        ...
                                        <CardContent className="p-6 bg-gradient-to-br from-amber-50/50 to-orange-50/50 dark:from-amber-950/20 dark:to-orange-950/20">
                                            ...
                                            <div className="space-y-3">
                                                {recipe.cookingTips.map((tip: any, index: number) => (
                                                    <div key={index} className="flex items-start gap-3 p-4 bg-white dark:bg-gray-900 rounded-lg border border-amber-200 dark:border-amber-800">
                                ...
                                {/* Complementary Items */}
                                {recipe.complementaryItems && recipe.complementaryItems.length > 0 && (
                                    <Card className="border-2 shadow-md border-purple-200 dark:border-purple-800">
                                        <CardContent className="p-6 bg-gradient-to-br from-purple-50/50 to-pink-50/50 dark:from-purple-950/20 dark:to-pink-950/20">
                                            ...
                                            <div className="grid gap-3">
                                                {recipe.complementaryItems.map((item: any, index: number) => (
                                                    <div key={index} className="flex items-center justify-between p-4 bg-white dark:bg-gray-900 rounded-lg border border-purple-200 dark:border-purple-800">
                                                        <span className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                                                            <div className="w-2 h-2 bg-purple-500 rounded-full" />
                                                            {item.quantity} {item.unit} {item.name}
                                                            {item.optional && <Badge variant="outline" className="text-xs ml-2">Optional</Badge>}
                                                        </span>
                                                        <span className="text-sm font-bold text-purple-600 ml-4">${item.cost.toFixed(2)}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </CardContent>
