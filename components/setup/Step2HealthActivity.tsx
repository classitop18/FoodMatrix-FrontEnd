...
export default function Step2HealthActivity({
  form,
  handleArrayToggle,
}: Step2Props) {
  const conditions = [
  ...
  const goals = [
    ...
    {
      value: "healthy_family_eating",
      label: "Healthy Family Eating",
      icon: "👨‍👩‍👧‍👦",
    },
  ];
      ...
      <div className="bg-white border-2 border-[#7661d3]/20 shadow-2xl rounded-2xl  p-6 shadow-lg border border-[#7661d3]/20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <Label
              htmlFor="height"
              className="text-[#3d326d] font-semibold mb-2 block"
            >
              Height (inches)
            </Label>
            <Input
          ...
          <div>
            ...
            <Select
              onValueChange={(value) =>
                form.setValue("activityLevel", value as any)
              }
            >
              <SelectTrigger
              ...
              <SelectContent>
                ...
                <SelectItem value="very_active">
                  🏋️ Very Active (intense exercise)
                </SelectItem>
              </SelectContent>
            </Select>
            {form.formState.errors.activityLevel && (
              <p className="text-sm text-red-500 mt-1">
                {String(form.formState.errors.activityLevel.message)}
              </p>
            )}
          </div>
        </div>
            ...
            {conditions.map((condition) => (
              ...
              >
                <Checkbox
                  ...
                  onCheckedChange={() =>
                    handleArrayToggle("conditions", condition.value)
                  }
            ...
            {allergies.map((allergy) => (
              ...
              >
                <Checkbox
                  ...
                  onCheckedChange={() =>
                    handleArrayToggle("allergies", allergy.value)
                  }
