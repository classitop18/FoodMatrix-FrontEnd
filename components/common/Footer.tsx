            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="flex flex-wrap gap-4 items-center justify-between">
                    ...
                    <nav className="flex flex-wrap items-center gap-6 text-sm">
                        <Link href="/" className="hover:text-[var(--green)] transition text-base lg:text-lg">Home</Link>
                        <Link href="#" className="hover:text-[var(--green)] transition text-base lg:text-lg">About Us</Link>
                        <Link href="#" className="hover:text-[var(--green)] transition text-base lg:text-lg">Why Food Matrix</Link>
                        <Link href="#" className="hover:text-[var(--green)] transition text-base lg:text-lg">Contact</Link>
                    </nav>

                    {/* <!-- SCROLL TOP BUTTON --> */}
                    <Link href={'#GoToNav'} className="flex items-center gap-4 text-base lg:text-lg cursor-pointer">
                        Go To Top
