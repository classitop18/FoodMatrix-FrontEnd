...
export function AccountSetupRequiredDialog({ isOpen, onClose }: { isOpen: boolean; onClose?: () => void }) {
    ...
    return (
        <Dialog open={open} onOpenChange={(val) => {
            ...
            <DialogContent className="sm:max-w-md bg-white border border-gray-100 shadow-2xl rounded-2xl p-0 overflow-hidden" onPointerDownOutside={(e) => e.preventDefault()} onEscapeKeyDown={(e) => e.preventDefault()}>
                <div className="bg-[#F3F0FD] p-6 text-center border-b border-gray-100">
                    ...
                    <DialogTitle className="text-xl font-extrabold text-[#313131]">Setup Your Account</DialogTitle>
                    <DialogDescription className="text-gray-500 mt-2 text-sm font-medium">
                        Welcome to FoodMatrix! To get started with managing your expenses and meals, you need to create your first account.
                    </DialogDescription>
                </div>
