...
export const API_ENDPOINTS = {
  ...
  BUDGET: {
    ...
    EXPENSE_FROM_RECEIPT: (accountId: string) => `/budget/${accountId}/expense-from-receipt`,
    EXPENSE_DETAILS: (accountId: string, dailyBudgetId: string) => `/budget/${accountId}/expense/${dailyBudgetId}/details`,
