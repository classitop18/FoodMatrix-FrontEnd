export const cuisineOptions = [
    ...
    { value: "mediterranean", label: "Mediterranean", icon: "🫒", region: "Europe" },
    ...
    { value: "turkish", label: "Turkish", icon: "🥙", region: "Europe/Middle East" },
    ...
    { value: "middle-eastern", label: "Middle Eastern", icon: "🧆", region: "Middle East" },
    { value: "lebanese", label: "Lebanese", icon: "🥙", region: "Middle East" },
    { value: "persian", label: "Persian (Iranian)", icon: "🍚", region: "Middle East" },
    { value: "moroccan", label: "Moroccan", icon: "🫖", region: "Middle East/Africa" },
    { value: "egyptian", label: "Egyptian", icon: "🫘", region: "Middle East/Africa" },
    ...
    { value: "argentinian", label: "Argentinian", icon: "🥩", region: "Americas" },
    ...
    { value: "south-african", label: "South African", icon: "🥩", region: "Africa" },
];
...
export const recipeDatabase: Recipe[] = [
    { id: "med-bowl", name: "Mediterranean Bowl", price: 18, cuisine: "mediterranean", prepTime: 25, servings: 4 },
    { id: "dal-soup", name: "Indian Dal Soup", price: 14, cuisine: "indian", prepTime: 30, servings: 4 },
    { id: "mex-salad", name: "Mexican Salad", price: 16, cuisine: "mexican", prepTime: 15, servings: 4 },
    { id: "butter-chicken", name: "Butter Chicken", price: 32, cuisine: "indian", prepTime: 45, servings: 4 },
    { id: "lamb-kofta", name: "Lamb Kofta", price: 35, cuisine: "mediterranean", prepTime: 40, servings: 4 },
    { id: "enchiladas", name: "Enchiladas", price: 30, cuisine: "mexican", prepTime: 35, servings: 4 },
];
