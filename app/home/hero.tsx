...
export default function HeroSection() {
  return (
    ...
    <section
      id="GoToNav"
      className="xl:max-h-[650px] xl:h-[650px] w-full bg-gradient-to-r from-[#F3F0FD] to-[#F3F0FD00] xl:py-[130px] pt-[50px] md:pb-[130px] relative"
    >
      <div className="xl:w-[1320px] mx-auto px-6 relative z-[1]">
        <div className="flex flex-col xl:flex-row gap-5 xl:gap-20 items-center xl:justify-start justify-center xl:text-left text-center">
          <div className="md:w-[590px] relative">
            ...
            <h1 className="text-3xl lg:text-[56px] font-extrabold leading-10 lg:leading-16 my-4">
              Meal Planning to Save Time, Cut Costs & Eat Healthier
            </h1>
            <p className="text-base lg:text-lg mb-8">
              Get personalized weekly meal plans tailored to your taste, goals,
              and lifestyle
            </p>
