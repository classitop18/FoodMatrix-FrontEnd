        ...
        <section className="py-14 lg:py-20 w-full bg-white relative">
            ...
            <div className="xl:w-[1116px] mx-auto px-6 relative">
                <CommonHeading
                    ...
                    headingName="FOOD_HEAD"
                />
                <FeatureCardSection />

                <div className="rounded-2xl bg-[#F3F0FD] shadow-lg py-5 px-8 mt-12 relative overflow-hidden lg:overflow-visible">
                    <div className="flex gap-6 lg:gap-12 items-center flex-wrap">
                        <div>
                            <span className="font-bold text-lg lg:text-xl">Begin Planning Healthier</span>
                            <h5 className="font-extrabold text-2xl lg:text-3xl">Meals with AI</h5>
                        </div>
                        <StartedButton label="Get Started Free" />
                    </div>
                    <Image
                        src={mealBoul}
                        className="h-auto absolute -right-16 lg:-right-16 bottom-0 top-3 m-auto"
                        width={200}
                        height={130}
                        alt="Logo Here"
                    />
