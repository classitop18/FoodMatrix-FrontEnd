    ...
    return (
        ...
        <section className="py-14 lg:py-20 w-full bg-[var(--primary)] relative overflow-hidden">
            ...
            <div className="xl:w-[1320px] mx-auto px-6 relative">
                ...
                <div className="md:max-h-[680px] md:max-w-[680px] max-h-[580px] max-w-[580px] w-auto h-auto mx-auto relative
                ...
                <div className="max-w-[462px] text-center text-white mx-auto font-extrabold lg:text-2xl md:text-xl text-lg md:mt-0 mt-5">Personalized recipes recommendation for every family member </div>
            </div>
        </section>
