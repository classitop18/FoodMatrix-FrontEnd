    ...
    <div className="min-h-screen bg-gradient-to-r from-[#F3F0FD] to-[#F3F0FD00] relative overflow-hidden w-full">
        ...
        {activeTab === "account" && (
          <div className="space-y-6 animate-scale-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-[var(--primary)]">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-[var(--green)]">
                <div className="flex items-center gap-3">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 border-transparent hover:border-[var(--primary-light)]">
                <div className="flex items-center gap-3">
            ...
            <Card className="border-0 shadow-2xl rounded-3xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-[var(--primary)] to-[var(--primary-light)] text-white pb-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <CardTitle className="flex items-center gap-3 text-xl font-extrabold py-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      className="h-11 rounded-xl border-2 border-gray-200 bg-white focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] transition-all text-sm font-medium"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      disabled
                      className="h-11 rounded-xl border-2 border-gray-200 bg-gray-100 cursor-not-allowed text-sm font-medium"
                    />
                  </div>
            ...
            <Card className="border-0 shadow-2xl rounded-3xl overflow-hidden bg-gradient-to-br from-[#F3F0FD] to-[#F3F0FD00]">
              {/* Header */}
              <CardHeader className="bg-[var(--primary)] text-white py-5">
      ...
      rounded-2xl border border-[#E6E1FF] shadow-md">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-extrabold text-base text-gray-900">Two-Factor Authentication</h4>
      ...
      rounded-2xl border border-[#E6E1FF] shadow-md">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-extrabold text-base text-gray-900">Change Password</h4>
      ...
      rounded-2xl border border-red-200 shadow-md">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-extrabold text-base text-gray-900">Logout from Account</h4>
                      <p className="text-xs text-gray-600">Sign out from your current session</p>
                    </div>
                  </div>
