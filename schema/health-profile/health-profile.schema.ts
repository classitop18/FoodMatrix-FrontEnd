...
export const healthProfileSchema = z.object({
  ...
  weight: z.coerce
    ...
    .max(500, "Weight must be less than 500 pounds")
    .optional(),
  activityLevel: z
  ...
  conditions: z
    ...
    .default([]),
  allergies: z
    .array(z.enum(["nuts", "dairy", "gluten", "shellfish", "soy", "eggs"]))
    .default([]),
  ...
  targetWeight: z.coerce
    .number()
    .min(50, "Target weight must be at least 50 pounds")
    .max(500, "Target weight must be less than 500 pounds")
    .optional(),
